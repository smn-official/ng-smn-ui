...
@Component({
    selector: 'ui-clock-content',
    templateUrl: './clock-content.component.html',
    styleUrls: ['./clock-content.component.scss'],
})
export class UiClockContentComponent implements AfterViewInit {
    maxDate: Date;
    minDate: Date;
    clock: any;
    ngModel: any;
